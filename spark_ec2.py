...
DEFAULT_SPARK_EC2_GITHUB_REPO = "https://github.com/porcobosso/spark-ec2"
...
def parse_args():
    ...
    parser.add_option(
        "--spark_master_uiport", default="8081",
        help="Set port for spark master webUI."
    )
...
def deploy_files(conn, root_dir, opts, master_nodes, slave_nodes, modules):
    ...
    template_vars = {
        ...
        "webui_port": opts.spark_master_uiport
    }
